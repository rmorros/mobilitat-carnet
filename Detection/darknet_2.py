...
if __name__ == "__main__":
    ...
    print("Files that will be detected are :"+ str(f))
    for image in f:
    	print("Detecting image :"+ str(image))
    	#start_time = time.time()
    	dictionary = performDetect(imagePath = "images/"+image, showImage=False ,makeImageOnly=True)
    	print("Image is :"+ str(dictionary))
    	#print("For the image "+ image+" there is a counter of "+ str(len(ObjectsList)) + " people")
    	#ellapsed_time = time.time() - start_time
    	#print("Time consumption for the detection: "+ str(ellapsed_time))

    	#cv2.imwrite('output/'+ image, dictionary['image'])
