...
class CentroidTracker:
        ...
        # EVM added 'categories' parameters
        def update(self, rects, categories):
                ...
                if len(rects) == 0:
                        ...
                        # to update
                        return (self.objects, self.rectangles, self.disappeared, self.categories)   #EVM added 'categories'
                ...
                if len(self.objects) == 0:
                        ...
                        for jj in range(0, len(inputCentroids)):
                                self.register(inputCentroids[jj], categories[jj],  inputRectangles[jj]) # JRMR: added inputRectangles argument
                ...
                # centroids
                        ...
                        # register each new input centroid as a trackable object
                                ...
                                for col in unusedCols:
                                        self.register(inputCentroids[col], categories[col], inputRectangles[col]) # JRMR: added argument inputRectangles[col]
                                                                                                                  # EVM: added argument categories[col]
                                        
                # return the set of trackable objects
                #return (self.objects, self.rectangles)
                return (self.objects, self.rectangles, self.disappeared, self.categories)  # EVM: added output "self.categories"
